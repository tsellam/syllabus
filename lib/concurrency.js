...
function genProblem(opts) {
  ...
  var db = genInitDB(serial);
  console.log(execute(serial, db));
  console.log(execute(schedule, db));
  console.log(isSerializable(schedule));
